...
- **مناسبت‌ها:** تقویم ایرانی + روزهای رسمی سازمان ملل، با ایدهٔ ریلز/بازی/شغل. برای کارالند مناسبت‌های قابل تولید محتوا (مثل آتش‌نشان، فضا، روز کودک) از قبل وصل می‌شود.
